...
if len(date_range) == 2:
    ...
    df = obtain_data_by_casino('Ajijic', start_date, end_date)
else:
...
if df.shape[0] == 0:
    ...
    df_casino_coor = pd.DataFrame({'lat_jitter': [20.2980925689187] , 'lon_jitter':[-103.24354224740361] , 'PLAYER_LEVEL_NAME': ['Casino Ajijic']})
