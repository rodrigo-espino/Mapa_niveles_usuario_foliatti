...
import pandas as pd
st.title("Esmeralda")
st.write("Ubicación de jugadores registrados en Esmeralda por nivel de jugador")
...
if len(date_range) == 2:
    ...
    df = obtain_data_by_casino('Esmeralda', start_date, end_date)
else:
    df = obtain_data_by_casino('Esmeralda')
...
if df.shape[0] == 0:
    ...
    df_casino_coor = pd.DataFrame({'lat_jitter': [19.54961985200153] , 'lon_jitter':[-99.28862737959567] , 'PLAYER_LEVEL_NAME': ['Casino Esmeralda']})
