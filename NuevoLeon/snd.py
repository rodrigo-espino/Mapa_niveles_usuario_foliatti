...
import datetime
st.title("Sendero")
st.write("Ubicación de jugadores registrados en Sendero por nivel de jugador")
...
if len(date_range) == 2:
    ...
    df = obtain_data_by_casino('Sendero', start_date, end_date)
else:
    df = obtain_data_by_casino('Sendero')
if df.shape[0] == 0:
