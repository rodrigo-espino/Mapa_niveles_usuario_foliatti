...
if len(date_range) == 2:
    ...
    df = obtain_data_by_casino('Mitras', start_date, end_date)
else:
...
if df.shape[0] == 0:
    ...
    df_casino_coor = pd.DataFrame({'lat_jitter': [25.71634506618017] , 'lon_jitter':[-100.34910735767211] , 'PLAYER_LEVEL_NAME': ['Casino Mitras']})
