...
st.title("Irapuato")
st.write("Ubicación de jugadores registrados en Irapuato por nivel de jugador")
...
if len(date_range) == 2:
    ...
    df = obtain_data_by_casino('Irapuato', start_date, end_date)
else:
    df = obtain_data_by_casino('Irapuato')
...
if df.shape[0] == 0:
    ...
    df_casino_coor = pd.DataFrame({'lat_jitter': [20.68425891451474] , 'lon_jitter':[-101.3895869301989] , 'PLAYER_LEVEL_NAME': ['Casino Irapuato']})
